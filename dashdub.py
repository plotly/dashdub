...
def generate_plot(step=1):
    ...
    fig.update_layout(height=250, margin_r=0, margin_l=0, 
        margin_t=0, yaxis_title='', yaxis_fixedrange = True)
...
app.layout = html.Div([
    ...
    dcc.Markdown('Written in 100 lines of Python with [Dash](https://dash.plot.ly/).'),
    dcc.Markdown('''
